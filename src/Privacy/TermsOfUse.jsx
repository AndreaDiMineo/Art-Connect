      ...
      <>
        ...
        <div style={{ marginTop: "6rem" }}>
          ...
          <div style={{ marginLeft: "6rem" }}>
            <p>
              Benvenuto nel  nosoosssitwwweb ArtConnect. Prima di utilizzaooii
              leggi attentamente i seguenti termini d'uso.
            </p>
            ...
            <p>
              L'applicazione è destinata solo a scopi informativi. Non
              garantiamo l'accuratezza o la completezza delle informazioni
              fornite nell'applicazione. L'utilizzo delle informazioni presenti
            ...
            <p>
              ...
              dell'applicazione. Utilizzi l'applicazione a tuo rischio e
              pericolo.
            </p>
            <h2>5. Modifiche ai Termini d'Uso</h2>
            <p>
              Ci riserviamo il diritto di modificare questi Termini d'Uso in
              qualsiasi momento. Ti consigliamo di visitare periodicamente
              questa pagina per verificare eventuali aggiornamenti.
            </p>
            <h2>6. Contattaci</h2>
            <p>
              Se hai domande o dubbi riguardo ai Termini d'Uso, contattaci
